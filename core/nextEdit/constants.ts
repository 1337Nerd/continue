...
> = {
  ...
  sweep: { topMargin: 10, bottomMargin: 10 },
};
...
// Sweep Next Edit-specific tokens.
export const SWEEP_FILE_SEP = "<|file_sep|>";
export const SWEEP_CODE_BLOCK_OPEN = "###";
export const SWEEP_DIFF_SECTION_HEADER = "original:";
export const SWEEP_DIFF_UPDATED_HEADER = "updated:";
export const SWEEP_CURRENT_FILE_PREFIX = "current/";
export const SWEEP_UPDATED_FILE_PREFIX = "updated/";
export const SWEEP_CURSOR = "<|cursor|>";
